...
<div id="cml-wizard">
  <div class="steps">
    <span class="<?php echo ( $step == 1 ) ? 'active' : 'done' ?>">
      ...
      <a class="title" href="<?php echo add_query_arg( array( "page" => "ceceppaml-language-page" ), $admin ) ?>">
        <?php _e( 'Manage your languages', 'ceceppaml' ) ?>
      </a>
    </span>
    <span class="<?php echo ( $step > 2 ) ? 'done' : $step2 ?>">
      <span class="number">2</span>
      <a class="title" href="<?php echo add_query_arg( array( "page" => "ceceppaml-options-page", "wstep" => 2 ), $admin ) ?>">
        <?php _e( 'Choose filter and url style', 'ceceppaml' ) ?>
      </a>
    </span>
    <span class="<?php echo ( $step == 3 ) ? 'active' : '' ?>">
      <span class="number">3</span>
      <a class="title" href="<?php echo add_query_arg( array( "wstep" => 3 ), admin_url() . "edit.php" ) ?>">
        ...
        <?php
          ...
          if( $page != "ceceppaml-language-page" ) {
            ...
            printf( __( 'Click <%s>here</a> to manage languages', 'ceceppaml' ),
                    'a href="' . add_query_arg( array( "page" => "ceceppaml-language-page", "wstep" => 1 ), $admin ) . '"' );
          } else {
           echo $p;
    ...
    <div class="<?php echo ( $step == 3 ) ? "visible" : "hidden" ?>">
      <p>
        ...
        <ul class="cml-ul-list">
          ...
          <li>
            <a href="<?php echo add_query_arg( array( "page" => "ceceppaml-translations-title", "wstep" => 3 ), admin_url() . "admin.php" ) ?>">
              <?php _e( 'Site Title/Tagline', 'ceceppaml' ); ?>
            </a>
          </li>

          <li>
            <a href="<?php echo add_query_arg( array( "page" => "ceceppaml-widgettitles-page", "wstep" => 3 ), admin_url() . "admin.php" ) ?>">
              <?php _e( 'Widget titles', 'ceceppaml' ); ?>
            </a>
          </li>

          <li>
            <a href="<?php echo add_query_arg( array( "page" => "ceceppaml-translations-plugins-themes", "wstep" => 3 ), admin_url() . "admin.php" ) ?>">
              <?php _e( 'Current theme', 'ceceppaml' ); ?>
            </a>
          </li>

          <li>
            <a href="<?php echo add_query_arg( array( "page" => "ceceppaml-language-page", "tab" => 2, "wstep" => 3 ), admin_url() . "admin.php" ) ?>">
      ...
      <p>
        ...
        <ul class="cml-ul-list">
          <li>
            <a href="<?php echo add_query_arg( array( "page" => "ceceppaml-flags-page", "wstep" => 3 ), admin_url() . "admin.php" ); ?>">
              <?php _e( 'Enable flags on your site/pages', 'ceceppaml' ) ?>
            </a>
          </li>
          <li>
            <a href="<?php echo add_query_arg( array( "wstep" => 3 ), admin_url() . "widgets.php" ); ?>">
              <?php _e( 'Filter widgets by language', 'ceceppaml' ) ?>
            </a>
          </li>
          <li>
            <a href="<?php echo add_query_arg( array( "page" => "ceceppaml-options-page", "wstep" => 3 ), admin_url() . "admin.php" ); ?>">
