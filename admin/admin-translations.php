...
//Current tab
$pages = array( "ceceppaml-translations-page", "ceceppaml-translations-menu", "ceceppaml-widgettitles-page", "ceceppaml-translations-title", "ceceppaml-translations-plugins-themes" );
